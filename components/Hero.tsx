...
export default function Hero() {
  ...
  return <section id="top" className="hero section-shell" onPointerMove={handlePointerMove} onPointerLeave={() => setDrops([])}>
    ...
    <div className="hero-identity">
      <div className="hero-portrait">{imageFailed ? <span aria-hidden="true">CM</span> : <img src={profile.imageHref} alt="Charbel Mdawar" width={1920} height={2560} fetchPriority="high" onError={() => setImageFailed(true)} />}</div>
    ...
    <div className="hero-bottom hero-enter" style={{animationDelay:"210ms"}}>
      <p>{profile.summary}</p>
      <div className="hero-actions"><a className="button button-primary" href="#work">Explore my work <ArrowUpRight size={17}/></a><a className="button button-secondary" href={profile.resumeHref} download="Charbel_Mdawar.pdf" type="application/pdf">Download CV <Download size={16}/><span className="file-type">PDF</span></a></div>
    </div>
