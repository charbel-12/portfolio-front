...
export default function Experience() {
 return <section id="experience" className="section-shell section-space">
   <Reveal><div className="section-heading"><p className="eyebrow">03 / Experience</p><h2>A foundation in quality.<br/><span className="text-muted">A focus on engineering.</span></h2></div></Reveal>
