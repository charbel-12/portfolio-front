...
export const experience: Experience[] = [
  ...
  { role: "Java Spring Developer / Team Lead", company: "Prokoders", period: "Jan 2025 — Nov 2025", summary: "Building enterprise identity and payment services with Java and Spring Boot.", points: ["Led a centralized SSO platform with Java 21, Spring Boot, Spring Security, OAuth 2.0, SAML, and JWT.", "Developed Britrip's platform-wide SSO and payment systems with Spring Boot, using Kafka as the central event hub and WebSocket for real-time notifications.", "Integrated Network International, Stripe, and Cryptomus into Britrip's payment system.", "Designed secure APIs and identity workflows covering roles, OTP, device trust, and audit-focused controls.", "Architected gateway integrations for checkout, capture, webhooks, and payment links with resilient error handling.", "Supported Oracle, Kafka events, WebSocket notifications, CI/CD, and Linux production troubleshooting."], stack: ["Java 21", "Spring Boot", "OAuth 2.0 / SAML", "Oracle", "Kafka"] },
  { role: "Laravel Developer", company: "Prokoders", period: "May 2024 — Nov 2025", summary: "Delivering real-time applications and improving performance across the stack.", points: ["Developed Laravel applications and reusable Blade components with WebSockets and Laravel Reverb.", "Built Britrip's support and ticketing system in Laravel; other Laravel backend developers connected their services to the shared SSO system.", "Maintained Nginx, SSL/TLS, caching headers, and deployment environments.", "Improved performance through query optimization, Redis caching, profiling, and targeted refactoring.", "Built PHPUnit and k6 tests to validate code quality and behavior under load."], stack: ["Laravel", "Blade", "Reverb", "Nginx", "PHPUnit", "k6"] },
...
export type Project = { name: string; tagline: string; status: string; description: string; highlights: { title: string; detail: string }[]; stack: string[]; architecture?: boolean; payments?: boolean; href?: string; secondary?: boolean };
export const projects: Project[] = [
  ...
  { name: "Britrip", tagline: "B2B travel · Identity, payments & support", status: "Spring Boot & Laravel development", href: "https://britrip.com/", payments: true,
    description: "Britrip is a B2B travel platform for agencies and businesses, bringing flights, hotels, and other travel services together. I developed its platform-wide SSO and payment systems with Spring Boot, plus a support and ticketing system with Laravel.",
    highlights: [
      { title: "Platform-wide SSO", detail: "Developed a shared single sign-on system for the whole platform. Kafka served as the central event hub, with WebSocket notifications delivering real-time updates." },
      { title: "Payment integrations", detail: "Developed the payment system and integrated Network International, Stripe, and Cryptomus to support the platform’s payment workflows." },
      { title: "Support & ticketing", detail: "Built the support and ticketing system in Laravel. Other Laravel backend developers connected their services to the shared SSO system." },
    ], stack: ["Spring Boot", "SSO", "Kafka", "WebSocket", "Laravel", "Payment integrations", "Support & ticketing"] },
